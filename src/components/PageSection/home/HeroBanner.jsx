...
import { Briefcase, CheckCircle, IdCard } from 'lucide-react';
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    ...
                    <div className="flex-1">
                        ...
                        <h2 className="text-2xl md:text-4xl font-black text-white leading-[1.15]">
                            ...
                            <span className="text-yellow-300 drop-shadow-sm">Govt Job Information Portal</span>
                        </h2>
                        <p className="text-white/70 text-sm mt-3 max-w-lg leading-relaxed font-medium">
                            Get instant updates on Latest Jobs, Results, Admit Cards & Syllabus — specifically curated for dedicated candidates.
                        </p>
